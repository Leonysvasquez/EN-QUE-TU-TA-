let profileWorkingFields = document.querySelector("#profileWorkingFields");
...
function addWorkExperience() {
    ...
    principalContainer.className = "border-bottom";
        ...
        dataFields.className = "data-fields";
            ...
            field2.className = "field";
                ...
                label2.textContent = "Puesto ocupado:";
                var field2Content = document.createElement("div");
                    ...
                    spanIcon2.textContent = "engineering";

                var inputText2 = document.createElement("input");
                inputText2.type = "text";
                inputText2.name = "workPosition";
                inputText2.id = "workPosition";

            var field1 = document.createElement("div");
            field1.className = "field";
                var label1 = document.createElement("label");
                label1.textContent = "Institución, Empresa, etc.:";
            ...
            field4.className = "field";
                ...
                var field4Content = document.createElement("div");
                    ...
                    spanIcon4.textContent = "date_range";

                var inputDate2 = document.createElement("input");
                inputDate2.type = "date";
                inputDate2.name = "workFinishDate";
                inputDate2.id = "workFinishDate";
            ...
            field3Content.appendChild(inputDate1);
            field3Content.appendChild(spanIcon3);
            field4Content.appendChild(inputDate2);
    ...
    profileWorkingFields.appendChild(principalContainer);
